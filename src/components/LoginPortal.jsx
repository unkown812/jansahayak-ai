    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
          ...
          <h2 style={{ fontSize: '1.5rem', fontWeight: 400, margin: 0, textAlign: 'center' }}>
            Command Center Authentication
          </h2>
          <p style={{ fontSize: '0.875rem', color: 'var(--body)', textAlign: 'center', margin: 0, lineHeight: 1.4 }}>
